...
export const Route = createFileRoute("/participant/results")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Your hackathon scores, rank and judge feedback." },
      { property: "og:title", content: "Results — HackArena" },
      { property: "og:description", content: "Detailed scoring breakdown and feedback." },
    ],
  }),
