  ...
  head: () => ({
    meta: [
      ...
      { title: "HackArena — Hackathon Management System" },
      {
        name: "description",
        content:
          "HackArena is a hackathon management platform for participants, organisers and judges.",
      },
      { name: "author", content: "HackArena" },
      { property: "og:title", content: "HackArena — Hackathon Management System" },
      {
